...
public class Order {
    ...
    public Order(String order_id1,String user_name_buyer1,String user_name_seller1,int vacation_id1,String number_of_tickets1,String order_status1,String last_update1){
        order_id = order_id1;
